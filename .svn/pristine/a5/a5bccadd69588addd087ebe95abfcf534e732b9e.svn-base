...
var api = "https://web.sh-taixun.com/chargingwechatclient";
...
var scoketip = "wss://web.sh-taixun.com/admin-api/charging/";
//=====
const base_url = "http://192.168.2.3:8081/car-charge-app-api";
// const base_url = "https://web.sh-taixun.com/car-charge-app-api";
