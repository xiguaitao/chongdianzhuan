	...
	<view class="container">
		<view class="main">
			<view class="mainContent">
				<view class="nav">
					<u-navbar :titleStyle="titleStyle" title="个人中心" :autoBack="true" bgColor="transparent"
						:fixed="false">
					...
					<view class="contentList">
						<u-cell-group :border="false">
							<u-cell :icon="item.icon" :title="item.title" isLink v-for="item in cellList" :key="item.id"
								:url="item.url"></u-cell>
							<u-cell v-if="invoiceStatus == 1" :icon="require('../../static/img/me_head.png')" title="发票抬头" isLink
								@click="invoiceHeader"></u-cell>
